    ...
    <>
      ...
      <div className="bg-white text-black">
        ...
        <section className="py-24 px-4 md:px-8 bg-gray-50">
          <h2 className="text-4xl font-light text-center mb-16">How It Works</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-6xl mx-auto">
            {[
              ...
              <div key={index} className="group hover:bg-white p-8 rounded-2xl transition-all duration-300 hover:shadow-lg">
                <div className="text-3xl font-light text-maroon mb-6">{item.number}</div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {[
                ...
                },
                {
                  title: "Event Types",
                  icon: "🎪",
                  links: ["Career Fairs", "Workshops", "Social Events", "Sports"]
                },
                {
                  title: "Organizations",
                  icon: "👥",
                ...
                <div key={index} className="space-y-4">
                  ...
                  <ul className="space-y-2">
                    {section.links.map((link, i) => (
                      <li key={i}>
                        <a href="#" className="text-gray-600 hover:text-maroon transition-colors">
                          {link}
                        </a>
                      </li>
                    ))}
        ...
        <section className="py-24 px-4 md:px-8 bg-gray-50">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-16">
            <div className="md:w-1/2">
              <h2 className="text-4xl font-light mb-8">For Student Organizations</h2>
              <p className="text-xl text-gray-600 mb-12">Reach more students and manage your events efficiently</p>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-12">
            {[
              ...
              <div key={index} className="text-center group hover:transform hover:scale-105 transition-all duration-300">
                <div className="text-5xl font-light text-maroon mb-4">{stat.number}</div>
        ...
        <section className="py-24 px-4 md:px-8 bg-gradient-to-r from-maroon to-darkmaroon text-white">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl mb-12 text-white/80">Join the largest event discovery platform for Aggies</p>
